...
<html>
  <head>
    <title>BrowserCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to BrowserCode.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>BrowserCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
