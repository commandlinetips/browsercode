...
function normalizeLoadedConfig(data: unknown, source: string) {
  ...
  delete copy.tui
  log.warn("tui keys in bcode config are deprecated; move them to tui.json", { path: source })
  return copy
}
...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServer.Server).annotate({
    description: "Server configuration for bcode serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommand.Info)).annotate({
    description: "Command configuration. See https://github.com/browser-use/browsercode for BrowserCode docs and https://opencode.ai/docs/commands for the upstream OpenCode reference.",
  }),
  ...
  agent: Schema.optional(
    ...
    description:
      "Agent configuration. See https://github.com/browser-use/browsercode for BrowserCode docs and https://opencode.ai/docs/agents for the upstream OpenCode reference.",
  }),
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const loadGlobal = Effect.fnUntraced(function* () {
      ...
      result = mergeConfig(result, yield* loadFile(path.join(Global.Path.config, "bcode.json")))
      result = mergeConfig(result, yield* loadFile(path.join(Global.Path.config, "bcode.jsonc")))
